...
(custom-set-variables
 ...
 '(package-selected-packages
   '(use-package quelpa-use-package quelpa protobuf-mode dap-mode php-mode kotlin-mode swift-mode dart-mode go-mode lsp-ui company corfu flycheck lsp-mode rust-mode))
 '(scroll-bar-mode nil)
...
;; C-1
(fset 'prep-select
      (kmacro-lambda-form [?\C-s return ?$ ?s ?q ?l ?  ?= ?  ?\" ?s ?e ?l ?e ?c ?t return ?\M-b ?\C-b ?n ?e ?w ?  ?D ?B backspace ?b ?Q ?u ?e ?r ?y ?\( ?\C-e ?\C-b ?\) ?\C-e return ?$ ?s ?q ?l ?- ?> ?s ?e ?t ?_ ?d ?a ?t ?a ?\( ?\) ?\; ?\C-b ?\C-b ?\" ?\" ?, ?  ?\[ ?\] ?\C-s return ?$ ?r ?e ?s ?u ?l ?t ?  ?= ?  ?$ ?G ?L ?O ?B ?A ?L ?S ?\[ ?\' ?d ?b ?_ ?l ?i ?n ?k ?\' ?\] ?- ?> ?q ?u ?e ?r ?y return ?\C-f ?\C-  ?\M-f backspace ?\M-b ?\M-f M-backspace ?g ?e ?t ?_ ?r ?e ?s ?u ?l ?t ?\M-b ?\M-b ?\M-b ?\M-f ?\C-f ?\C-f ?\C-  ?\M-b ?\M-b ?\M-b backspace ?s ?q ?l ?\C-p ?\C-e ?\C-r return ?- ?> ?s ?e ?t ?_ ?d ?a ?t ?a return ?\C-e return ?$ ?q ?u ?e ?r ?y ?_ ?s ?u ?c ?c ?e ?e ?d ?e ?d ?  ?= ?  ?$ ?s ?q ?l ?- ?> ?e ?x ?e ?c ?u ?t ?e ?\( ?\) ?\; ?\C-s return ?$ ?r ?e ?s ?u ?l ?t ?  ?= ?  ?$ ?s ?q ?l ?- ?> ?g ?e ?t ?_ ?r ?e ?s ?u ?l ?t return ?\M-b ?\M-b ?\M-b ?\M-b ?\C-b ?\C-b ?$ ?q ?u ?e ?r ?y ?_ ?s ?u ?c ?c ?e ?e ?d ?e ?d ?  ?& ?& ?  ?\C-r return ?s ?e ?t ?_ ?d ?a ?t ?a ?\( ?\" ?\" return ?\M-f ?\M-f ?\C-f ?\C-f] 0 "%d"))

;; C-2
(fset 'fill-bindings
      (kmacro-lambda-form [?\C-s return ?$ ?s ?q ?l ?  ?= ?  return ?\C-s return ?\' ?\" ?. return backspace backspace backspace ?? ?\C-  ?\C-s return ?. ?\" ?\' return ?\C-b ?\C-b ?\C-b ?\C-w ?\C-d ?\C-d ?\C-d ?\C-s return ?$ ?s ?q ?l ?- ?> ?s ?e ?t ?_ ?d ?a ?t ?a ?\( return ?\C-e ?\C-b ?\C-b ?\C-b ?\C-y ?, ?  ?\C-r return ?$ ?s ?q ?l ?  ?= ?  return] 0 "%d"))

;; C-3
(fset 'prep-ins-del-update
      (kmacro-lambda-form [?\M-x ?r ?e ?g ?e backspace backspace backspace backspace ?s ?e ?a ?r ?c ?h ?- ?f ?o ?r ?w ?a ?r ?d ?- ?r ?e ?g tab return ?\\ ?4 backspace ?$ ?s ?q ?l ?  ?= ?  ?\" ?\[ ?^ ?s ?\] return ?\C-b ?\C-b ?n ?e ?w ?  ?D ?b ?Q ?u ?e ?r ?y ?\( ?\C-e ?\C-b ?\) ?\C-e return ?$ ?q ?u ?e backspace backspace backspace ?s ?e backspace ?q ?l ?- ?> ?s ?e ?t ?_ ?d ?a ?t ?a ?\( ?\" ?\" ?, ?  ?\[ ?\] ?\) ?\; return ?$ ?q ?u ?e ?r ?y ?_ ?s ?u ?c ?c ?e ?e ?d ?e ?d ?  ?= ?  ?$ ?s ?q ?l ?- ?> ?e ?x ?e ?c ?u ?t ?e ?\( ?\) ?\; ?\C-s return ?i ?f ?  ?\( return ?$ ?q ?u ?e ?r ?y ?_ ?s ?u ?c ?c ?e ?e ?d ?e ?d ?  ?\C-b ?\C-  ?\C-s return ?\) ?  ?\{ return ?\C-b ?\C-b ?\C-b backspace ?\C-r return ?$ ?s ?q ?l ?- ?> ?s ?e ?t ?_ ?d ?a ?t ?a ?\( ?\" return ?\M-f ?\M-f ?\M-f ?\C-f ?\C-f] 0 "%d"))

;; C-4
(fset 'fill-bindings-no-dot
      (kmacro-lambda-form [?\C-s return ?  ?\' ?$ return ?\C-b backspace ?\C-  ?\C-s return ?\' return ?\C-b ?\C-w ?\C-d ?? ?\C-s return ?- ?> ?s ?e ?t ?_ ?d ?f ?a ?t ?e backspace backspace backspace backspace ?a ?t ?a ?\( return ?\C-s return ?\] ?\) return ?\C-b ?\C-b ?\C-y ?, ?  ?\C-r return ?$ backspace ?n ?e ?w ?  ?D ?b ?Q ?u ?e ?r ?y ?\( return] 0 "%d"))

;; C-5
(fset 'prepare-file-for-sql-updates
      (kmacro-lambda-form [?\M-< ?\M-x ?s ?e ?a ?r ?c ?h ?_ ?f ?o ?r backspace backspace backspace backspace ?- ?f ?o ?r ?a backspace ?w ?a ?r ?d tab ?- tab ?r ?e ?g tab return ?i ?n ?c ?l ?u ?d ?e ?_ ?o ?n ?c ?e ?. ?* ?/ ?u ?t ?i ?l ?s ?/ return ?\C-a ?\C-  ?\C-e ?\M-w return ?\C-y ?\C-r return ?/ ?u ?t ?i ?l ?s ?/ return ?\M-f ?\C-f ?\C-  ?\C-s return ?. ?p ?h ?p return ?\M-b ?\C-b backspace ?D ?b ?Q ?u ?e ?r ?y ?\C-x ?r ?$ ?r ?e ?s ?u ?l ?t ?- ?> ?f ?r ?e ?e ?\( ?\) ?\; ?\C-q ?\C-j return return ?\M-< ?\C-x ?r ?$ ?G ?O S-backspace ?L ?O ?B ?A ?L ?- backspace ?\[ ?\' ?d ?b ?_ ?l ?i ?n ?k ?\' ?\] ?- ?? backspace ?> ?e ?r ?r ?o ?r return ?$ ?s ?q ?l ?- ?> ?g ?e ?t ?_ ?r ?e backspace backspace ?e ?r ?r ?o ?r ?\( ?\) return ?\M-< ?\C-x ?r ?$ ?G ?L ?O ?B ?A ?L ?\[ ?d ?b backspace backspace ?\' ?d ?b ?_ ?l ?i ?n ?k ?\' ?\] ?- ?> ?s backspace ?g ?e ?t ?_ ?i ?n ?s ?e ?r ?t ?_ ?i ?d ?\( ?\) backspace backspace backspace backspace backspace backspace backspace backspace backspace backspace backspace backspace backspace backspace backspace ?i ?n ?s ?e ?r ?t ?_ ?i ?d return ?$ ?s ?q ?l ?- ?> ?g ?e ?t ?_ ?i ?n ?s ?e ?r ?t ?_ ?i ?d ?\( ?\) return ?\M-< ?\C-x ?r return ?\M-<] 0 "%d"))

;; C-0
(fset 'unify-lines-in-query
      (kmacro-lambda-form [?\M-x ?s ?e ?a ?r ?c ?h ?- ?f ?o ?r ?w ?a ?r ?d ?- ?r ?e ?g ?e ?x ?p return ?\" ?\[ ?\[ ?: ?s ?p ?a ?c ?e ?: ?\] ?\] ?+ backspace ?* ?\C-q ?\C-j ?\[ ?\[ ?: ?s ?p ?a ?c ?e ?: ?\] ?\] ?* ?\\ ?. ?\[ ?\[ ?: ?s ?p ?a ?c ?e ?: ?\] ?\] ?* ?\" return ?\C-  ?\C-b ?\C-r return ?\" return backspace] 0 "%d"))

;; C-9
(fset 'enforce-query-line-limit
      (kmacro-lambda-form [?\M-g tab ?1 ?1 ?0 return ?\C-r return ?  return ?\C-f ?\" ?. return ?\"] 0 "%d"))
